...
public final class Semaphore {
    ...
    /**
     * Entspricht dem P() Eintritt (Passieren) in einen synchronisierten Bereich, wobei mitgezählt
     * wird, der wievielte Eintritt es ist. Falls der Zähler null ist wird der Aufrufer blockiert.
    ...
    /**
     * Entspricht dem V() Verlassen (Freigeben) eines synchronisierten Bereiches, wobei ebenfalls
     * mitgezählt wird, wie oft der Bereich verlassen wird.
     */
