 ...
 */
package ch.hslu.ad.n21.startingline;
 ...
 */
public class DemoStartingLine {

    private static final Logger LOG = LogManager.getLogger(DemoStartingLine.class);

    /**
     * Privater Konstruktor.
     */
    private DemoStartingLine() {
    }
    ...
    public static void main(final String args[]) throws InterruptedException {
        final StartingLine line = new StartingLine();
