...
public class RailwayNet1Test {
    private final static org.apache.logging.log4j.Logger LOG = LogManager.getLogger(RailwayNet1Test.class);
    RailwayNet1 rn;
    ...
    public void numberOfConnections() {
        assertEquals(6, rn.numberOfConnections());
    }

    @Test
    public void isDirect() {
        assertEquals(true, rn.isDirect("Luzern","Zofingen"));
        assertEquals(true, rn.isDirect("Zofingen","Luzern"));
    }
